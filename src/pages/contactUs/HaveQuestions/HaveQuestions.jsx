        ...
        <div className="right flex w-full flex-col gap-[1.5rem] px-10 mobile:px-5 md:w-[70%] ">
          ...
          >
            ...
            <div className="upperInputArea">
              {forms.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <label
                      className=" mobile:reponsiveMiniText1 w-full text-start text-[1rem]"
            ...
            <div className=" flex w-full flex-col gap-[.3rem]">
              ...
              <textarea
                className=" mobile:reponsiveMinnpiText1 h-[13rem] w-full resize-none rounded-lg px-[.5rem] py-[.5rem] text-[1rem] ring-1 ring-[#D9DADB] active:ring-black"
                id="message"
                name="message"
