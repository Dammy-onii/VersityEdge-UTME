...
function HearFromYou() {
  return (
    <section className=" hearFromYou generalPadding flex h-[40rem] w-full flex-col justify-between gap-[1rem] py-[3rem] sm:h-[50rem] md:h-[60rem] md:gap-[2rem] lg:h-[80rem] ">
